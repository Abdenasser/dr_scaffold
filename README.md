...
This library will help you to scaffold full **Restful API Resources** in
seconds using only one command:
...
- and more ... .. raw:: html \</br\>\</br\>

# Installation and usage

### For a detailed guide read [scaffold django apis like a champion](https://www.abdenasser.com/scaffold-django-apis)

This library assumes that you have setup your project with **Django Rest
Framework**. if not, please refer to [this
guide](https://www.django-rest-framework.org/#installation)
